...
class FileStorageConfig(BaseModel):
    ...
    backend: FileStorageBackend = Field(default=FileStorageBackend.MINIO, description="Storage backend")
    ...
    bucket_name: str = Field(default="voice-files", description="Storage bucket name")
    upload_path: str = Field(default="/tmp/voice_uploads", description="Local upload path")
...
class VoiceConfig(BaseModel):
    ...
    file_storage: FileStorageConfig = Field(default_factory=FileStorageConfig, description="File storage configuration")
    
    # Global settings
    default_language: str = Field(default="en-US", description="Default language for STT/TTS")
    fallback_enabled: bool = Field(default=True, description="Enable provider fallback")
    fallback: bool = Field(default=True, description="Enable provider fallback (alias for fallback_enabled)")
