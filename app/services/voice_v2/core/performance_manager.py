...
class VoicePerformanceManager:
    ...
    async def initialize(self, available_providers: List[ProviderType]) -> None:
        ...
        logger.info("Initializing performance system - Level: %s", self.config.level.value)
        ...
        try:
            ...
            logger.error("Performance system initialization failed: %s", e)
            raise
    ...
    async def run_performance_validation(self, duration_minutes: int = 5) -> Dict[str, Any]:
        ...
        logger.info("Running performance validation (%s minutes)", duration_minutes)
    ...
    async def shutdown(self) -> None:
        ...
        try:
            ...
            logger.error("Error during performance system shutdown: %s", e)
