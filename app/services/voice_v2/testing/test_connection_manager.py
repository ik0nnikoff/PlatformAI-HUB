...
class TestVoiceConnectionManager:
    ...
    def test_manager_initialization(self, manager, mock_settings, mock_health_checker, mock_metrics_collector):
    ...
    async def test_cleanup_handles_pool_errors(self, manager):
        ...
        with patch.object(manager._pools["openai"], 'cleanup', side_effect=Exception("Cleanup failed")):
...
class TestConnectionManagerHelpers:
    ...
    def test_create_connection_manager_with_all_dependencies(self, mock_settings, mock_health_checker, mock_metrics_collector):
