...
async def grade_documents(state):
    ...
    if rewrite_count == 0:
        print("---FIRST TIME QUESTION---")
        question = messages[-3].content
        
    else:
        print("---REWRITE QUESTION COUNT: ", rewrite_count)
    ...
    async def process_doc(doc):
        ...
        try:
            ...
            print(f"Scored result: {scored_result.binary_score}")
